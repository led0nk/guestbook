...
// 	authRouter.GET("/create", createHandler())
// 	authRouter.POST("/create", createEntry(userstore, gueststore))
...
// 		tmplt.Execute(c.Writer, nil)
// 	}
// }

// func createEntry(u db.UserStorage, b db.GuestBookStorage) gin.HandlerFunc {
// 	return func(c *gin.Context) {
// 		tmplt, _ := template.ParseFiles("templates/index.html", "templates/loggedinheader.html", "templates/create.html")
// 		c.Request.ParseForm()
// 		session, _ := cookies.Get(c.Request, "session")
...
// 		newEntry := model.GuestbookEntry{Name: user.Name, Message: c.Request.FormValue("message"), UserID: user.ID}
